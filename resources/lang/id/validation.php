    ...
    */
    ...
    'custom' => [
        'nama_menu' => [
            ...
            'string'   => 'Kolom NAMA MENU harus berupa string.',
            'max'      => 'Kolom NAMA MENU tidak boleh lebih dari :max karakter.',
        ],

        'harga' => [
             'required' => 'Kolom NISN harus diisi.',
             'integer'   => 'Kolom NISN harus berupa string.',
        ...
        'id_category'  => [
            'required' => 'Kolom CATEGORY harus diisi.'
        ],
        ...
        'nama_category' => [
            'required'  => 'Nama CATEGORY harus diiisi.',
            'string'    => 'Nama CATEGORY harus string.',
            'max'       => 'Nama CATEGORY Maksimum 20 karakter.',
        ],

        'nama_negara' => [
            'required'  => 'Nama NEGARA harus diiisi.',
            'string'    => 'Nama NEGARA harus string.',
            'max'       => 'Nama NEGARA Maksimum 30 karakter.',
        ],
